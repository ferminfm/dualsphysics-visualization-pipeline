...
4. `evidence/LAYER1_V31_DECISION.md`
5. `evidence/SURFACE_RECIPE_DECISION_V31.md`
6. `evidence/FIELD_PANEL_CORRECTION_V31.md`
7. `videos_proxy/long_primary_route_blender_sequence_v31.mp4`
8. `videos_proxy/round_vs_rectangular_split_screen_v31.mp4`
9. `videos_proxy/task05_field_visualization_reel_v31_no_pressure.mp4`
10. `evidence/TASK06_RELEASE_BLOCKERS.md`
...
Layer 1 accepted the V3.1 primary/split-screen/field reels for internal review only. Public packaging remains blocked; see `evidence/LAYER1_V31_DECISION.md`.
