...
void mg_cycle (scalar * a, scalar * res, scalar * da,
	       void (* relax) (scalar * da, scalar * res,
			       int depth, void * data),
	       void * data,
	       int nrelax, int minlevel, int maxlevel, int trace_cycle)
{
  ...
  internal_nozzle_mg_trace_stage
    ("cycle_after_residual_restriction", a, res, res, da,
     trace_cycle, minlevel, nrelax, nodata);
#endif
...
#if INTERNAL_NOZZLE_PROJECTION_TRACE
    internal_nozzle_mg_trace_stage
      ("cycle_after_level_relax", a, res, res, da,
       trace_cycle, l, nrelax, nodata);
#endif
  }
...
#if INTERNAL_NOZZLE_PROJECTION_TRACE
  internal_nozzle_mg_trace_stage
    ("cycle_after_solution_correction", a, res, res, da,
     trace_cycle, maxlevel, nrelax, nodata);
#endif
}
...
#if INTERNAL_NOZZLE_PROJECTION_TRACE
  internal_nozzle_mg_trace_stage
    ("solve_after_initial_residual", a, b, res, res,
     -1, minlevel, s.nrelax, s.resa);
#endif
...
#if INTERNAL_NOZZLE_PROJECTION_TRACE
    internal_nozzle_mg_trace_stage
      ("solve_after_cycle_residual", a, b, res, da,
       s.i, grid->maxdepth, s.nrelax, s.resa);
#endif
...
#endif // EMBED
#if INTERNAL_NOZZLE_PROJECTION_TRACE
  internal_nozzle_poisson_trace_stage
    ("after_coefficient_restriction", a, b, alpha, lambda,
     tolerance ? tolerance : TOLERANCE, nrelax, max(1, minlevel));
#endif
...
#if INTERNAL_NOZZLE_PROJECTION_TRACE
  internal_nozzle_projection_trace_stage
    ("after_divergence_pre_poisson", uf, p, alpha, div, dt, nrelax);
#endif
...
#if INTERNAL_NOZZLE_PROJECTION_TRACE
  internal_nozzle_projection_trace_summary
    (p, mgp.i, mgp.resb, mgp.resa, mgp.sum, mgp.nrelax, mgp.minlevel);
#endif
...
#if INTERNAL_NOZZLE_PROJECTION_TRACE
  internal_nozzle_projection_trace_stage
    ("after_velocity_correction", uf, p, alpha, div, dt, mgp.nrelax);
#endif
