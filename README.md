...
generated by the official script. See `docs/dualsphysics_shapesinlet3d_showcase.md`
for exact paths, commands, manifest, and Blender next steps. All heavy artifacts
remain outside Git under the stable stack-validation root.
