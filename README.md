...
generated by the official script. Headless Blender render produced 1280x720 MP4 (~11s) + contact sheet
from all 101 PartFluid frames (isometric oblique, legible markers, caption). See `docs/dualsphysics_shapesinlet3d_showcase.md`
for paths, params, and caveats. All heavy artifacts outside Git.
